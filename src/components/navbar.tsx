    ...
    <Disclosure as="nav" className="">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 right-0 flex flex-row justify-center items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <button
              type="button"
            ...
            {/* Profile dropdown */}
            <div className="relative h-full flex flex-col items-center ml-3">
              <UserButton />
            </div>
          </div>
        </div>
